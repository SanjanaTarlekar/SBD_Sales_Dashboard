...
Interactive map visual — Country and Region-wise sales with zoom/pan controls
Clustered column chart — Sum of Sales by Category
Donut chart with % breakdown — Sum of Sales by Region
